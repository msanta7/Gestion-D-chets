...
public class addInterventionController implements Initializable {
    ...
    private void handleValider() {
        ...
        try {
            ...
            System.out.println("=== DEBUG: Création date planification ===");
            System.out.println("Date picker value: " + datePlanificationPicker.getValue());
            System.out.println("Heure combo value: " + heurePlanificationCombo.getValue());

            // Combiner date et heure - CORRECTION IMPORTANTE
            ...
            int minutes = heureParts.length > 1 ? Integer.parseInt(heureParts[1]) : 0;

            LocalTime time = LocalTime.of(heures, minutes);
            LocalDateTime datePlanification = LocalDateTime.of(date, time);

            // DEBUG: Afficher la date créée
            System.out.println("Date planification créée: " + datePlanification);
            System.out.println("Formaté: " + datePlanification.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")));
            ...
            if (enModeModification && interventionAModifier != null) {
                ...
                // DEBUG
                System.out.println("Intervention modifiée - Date: " + interventionAModifier.getDatePlanification());
                ...
                // DEBUG
                System.out.println("Nouvelle intervention - Date: " + nouvelleIntervention.getDatePlanification());
                System.out.println("Formaté: " + nouvelleIntervention.getDatePlanificationFormatted());
